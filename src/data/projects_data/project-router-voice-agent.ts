...
export const livekitAgent: ProjectBase = {
    ...
    detailedContent: [
        ...
        {
            type: 'image',
            src: 'images/projects/genix_livekit_diagram.png',
        ...
        {
            type: 'image',
            src: 'images/projects/genix_livekit_wifi_qrcode.png',
            alt: 'Wi-Fi QrCode generated by the agent'
        },
        {
            type: 'image',
            src: 'images/projects/genix_livekit_security_events.png',
            alt: 'Show security events to help user monitor and manage the network'
        },
        {
            type: 'image',
            src: 'images/projects/genix_livekit_bedtime.png',
            alt: 'Support setting bed time by human language'
        },
        {
            type: 'image',
            src: 'images/projects/genix_livekit_apps_timeline.png',
