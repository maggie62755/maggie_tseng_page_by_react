...
export const macAnalysis: ProjectBase = {
    ...
    detailedContent: [
        ...
        {
            type: 'image',
            src: `${import.meta.env.BASE_URL}images/projects/mac_sim.png`,
            alt: '流程圖'
        },
        {
            type: 'paragraph',
        ...
        {
            type: 'image',
            src: `${import.meta.env.BASE_URL}images/projects/mac_sim_result.png`,
            alt: 'MAC行為相似度分析結果範例'
        }
    ],
    ...
    status: "Completed",
    date: "2025/11",
    image: `${import.meta.env.BASE_URL}images/projects/mac_sim_title.png`,
    link: "#",
    sourceCode: "#"
};
